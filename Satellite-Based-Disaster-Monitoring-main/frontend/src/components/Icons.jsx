// Clean line icons (Lucide-style, 24x24, stroke-based). No emoji anywhere.
...
const PATHS = {
  ...
  flame: (
    <path d="M12 2c1 3 4 4.5 4 8a4 4 0 0 1-8 0c0-1 .3-1.8.5-2.5C7 8.5 8 4.5 12 2z" />
  ),
  wind: (
    <>
  ...
  palette: (
    <>
      ...
      <path d="M12 2a10 10 0 1 0 0 20 2.5 2.5 0 0 0 2-4 2.5 2.5 0 0 1 2-4h1.5A4.5 4.5 0 0 0 22 9.5 10 10 0 0 0 12 2z" />
    </>
  ),
  trendUp: (
    <>
